    ...
    <div className="min-h-screen flex items-center justify-center bg-luxury-900 text-luxury-50 px-4">
      <div className="w-full max-w-md">
        <div className="bg-luxury-800 p-8 rounded-lg shadow-xl border border-luxury-700">
          <h1 className="text-3xl font-bold mb-6 text-center bg-gradient-to-r from-luxury-gold to-luxury-silver bg-clip-text text-transparent">
            Welcome Back
          </h1>
          ...
          <p className="mt-6 text-center text-luxury-400">
            ...
            <Link href="/auth/signup" className="text-luxury-gold hover:text-luxury-bronze">
              Sign up
            </Link>
          </p>
        </div>
